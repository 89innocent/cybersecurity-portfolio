...
# Security configuration: keep secrets outside the source code.
...
<html>
<head>
    <title>Login - Real-Time SOC Malware Defense System</title>
    <style>
        body {
            margin: 0;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            /* Background image with a dark gradient overlay for optimal readability */
            background: linear-gradient(rgba(11, 18, 32, 0.75), rgba(11, 18, 32, 0.85)), 
                        url("{{ url_for('static', filename='login-bg.jpg') }}");
        ...
        .login-card {
            background: rgba(17, 26, 46, 0.9); /* Slightly translucent card backdrop */
...
<body>
    <div class="login-card">
        <div class="login-header">🛡 SOC ADMIN LOGIN</div>
        {% if error %}
        ...
        <div class="demo-info">Authorized access only.</div>
    </div>
</body>
</html>
"""
# ========================================================
# 📊 DASHBOARD HTML TEMPLATE (WITH LOGOUT BUTTON)
# ========================================================
HTML = """
<!DOCTYPE html>
<html>
